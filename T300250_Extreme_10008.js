var ScriptTemp_T300250_Extreme_10008 = document.createElement('script');
                            ScriptTemp_T300250_Extreme_10008.type = 'text/template';
                            ScriptTemp_T300250_Extreme_10008.id = 'TempID_T300250_Extreme_10008';
                            ScriptTemp_T300250_Extreme_10008.text = "<li> \
                    <div class='alertCAP_banner alertCAP_banner02 bannerYellow banner300X250' style='width:300px;margin: 0px auto;'>\
                         <div class='block_up' style='background-color:#086471;color:#ffffff;height:70px;'>\
                              <div class='alertCAP_Area'>南投縣</div>\
                         ...
                         <div class='block_down' style='background-color:#d9ead3;color:#000000;height:200px;font-size:16px'>\
                            ...
                            document.head.appendChild(ScriptTemp_T300250_Extreme_10008);
var EventStr = "土石流,分洪警報,水庫放流,火災,市話通訊中斷,地震,行動電話中斷,低溫,防空,林火危險度預警,河川高水位,空氣品質,枯旱預警,降雨,海嘯,高溫,停班停課,國家公園入園示警,強風,淹水,疏散避難,堰塞湖警戒,傳染病,道路封閉,雷雨,颱風,濃霧,濃霧,輻射災害,水位警示,水位警戒,水門資訊,水門資訊,地下道封閉,區排警戒,開放路邊停車,開放臨時停車,道路施工,停水,停水,電力中斷,鐵路事故,鐵路事故,血液庫存,疫苗供應狀況,結構火災";
var VillageId = "";
var SeverityLevel = "";
var SeverityLevel = "";
var capdata_T300250_Extreme_10008 ={};
capdata_T300250_Extreme_10008.Newflag =false;
capdata_T300250_Extreme_10008.Timestamp ='';
capdata_T300250_Extreme_10008.Topic ='10008';
capdata_T300250_Extreme_10008.Datas =[];
function iniCapData_Json_T300250_Extreme_10008(){
if(typeof($("#CapModule_T300250_Extreme_10008").attr("id")) != "undefined"){var div = document.createElement('div');var ul = document.createElement('ul');  var FilterDataFlag = false;ul.id='portfolio';

                                var AlertImage = '';
                                $.each(capdata_T300250_Extreme_10008.Datas, function (value, item) {
                                    let today = new Date();
                                    let date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate()+' '+today.getHours()+':'+today.getMinutes();
                                    let Expires = item.Expires;

                                    AlertImage = GetBannerImg(item.Code);
                                    var template = $('#TempID_T300250_Extreme_10008').html();
                                    template = template
 ...
 if(EventStr.indexOf(item.Event)!= '-1'){  
            ...
            template = template.replace(/{{@Summary}}/g, '現在沒有示警');
										$(ul).append(template);
        }$(div).append(ul);$("#CapModule_T300250_Extreme_10008").html("");$("#CapModule_T300250_Extreme_10008").append($(div).html());
								$('ul#portfolio').innerfade({speed: 2000,timeout: 5000,type: 'sequence',containerheight: '100px'});
								}}
setInterval(AjaxCall_T300250_Extreme_10008, 60000);setTimeout(AjaxCall_T300250_Extreme_10008, 2000); function AjaxCall_T300250_Extreme_10008() {
var suid1 = 'capdata_T300250';var suid2 = '_Extreme_';
var suid3 = '10008';
if(suid3.length>7){suid3 = suid3.substring(0,7);}
var suid = suid1+suid2+suid3;
console.log(suid); var WebAPI= 'https://alertsmodule.ncdr.nat.gov.tw/DataWebAPI/api/CapData'+'?CapModuleType='+3+'&suid='+suid3+'&timeStamp='+capdata_T300250_Extreme_10008.Timestamp+'&format=json&ApiKey=E03F2189-3202-4B60-B9CA-FBB74418D144';
 $.getJSON(WebAPI, function (data) {
                              if(data == null){
								var today = new Date();
								var Nodata = {};
								Nodata.Topic = capdata_T300250_Extreme_10008.Topic;
        ...
        capdata_T300250_Extreme_10008 = Nodata;
							}else{
                            if (data.Newflag) {         capdata_T300250_Extreme_10008 = data;
								capdata_T300250_Extreme_10008.Timestamp = data.Timestamp;
                            } else {
                                // alert('no change');
                            }}
                            iniCapData_Json_T300250_Extreme_10008();
