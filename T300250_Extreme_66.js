var ScriptTemp_T300250_Extreme_66 = document.createElement('script');
                            ScriptTemp_T300250_Extreme_66.type = 'text/template';
                            ScriptTemp_T300250_Extreme_66.id = 'TempID_T300250_Extreme_66';
                            ScriptTemp_T300250_Extreme_66.text = "<li> \
                    <div class='alertCAP_banner alertCAP_banner02 bannerYellow banner300X250' style='width:300px;margin: 0px auto;'>\
                         ...
                         <div class='block_down' style='background-color:#d9ead3;color:#000000;height:200px;font-size:16px'>\
                            ...
                            document.head.appendChild(ScriptTemp_T300250_Extreme_66);
...
var SeverityLevel = "";
var SeverityLevel = "";
var capdata_T300250_Extreme_66 ={};
capdata_T300250_Extreme_66.Newflag =false;
capdata_T300250_Extreme_66.Timestamp ='';
capdata_T300250_Extreme_66.Topic ='66';
capdata_T300250_Extreme_66.Datas =[];
function iniCapData_Json_T300250_Extreme_66(){
if(typeof($("#CapModule_T300250_Extreme_66").attr("id")) != "undefined"){var div = document.createElement('div');var ul = document.createElement('ul');  var FilterDataFlag = false;ul.id='portfolio';

                                var AlertImage = '';
                                $.each(capdata_T300250_Extreme_66.Datas, function (value, item) {
                                    let today = new Date();
                                    let date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate()+' '+today.getHours()+':'+today.getMinutes();
                                    let Expires = item.Expires;

                                    AlertImage = GetBannerImg(item.Code);
                                    var template = $('#TempID_T300250_Extreme_66').html();
                                    template = template
 ...
 if(EventStr.indexOf(item.Event)!= '-1'){  
            ...
            template = template.replace(/{{@Summary}}/g, '現在沒有示警');
										$(ul).append(template);
        }$(div).append(ul);$("#CapModule_T300250_Extreme_66").html("");$("#CapModule_T300250_Extreme_66").append($(div).html());
								$('ul#portfolio').innerfade({speed: 2000,timeout: 5000,type: 'sequence',containerheight: '100px'});
								}}
setInterval(AjaxCall_T300250_Extreme_66, 60000);setTimeout(AjaxCall_T300250_Extreme_66, 2000); function AjaxCall_T300250_Extreme_66() {
var suid1 = 'capdata_T300250';var suid2 = '_Extreme_';
var suid3 = '66';
if(suid3.length>7){suid3 = suid3.substring(0,7);}
var suid = suid1+suid2+suid3;
console.log(suid); var WebAPI= 'https://alertsmodule.ncdr.nat.gov.tw/DataWebAPI/api/CapData'+'?CapModuleType='+3+'&suid='+suid3+'&timeStamp='+capdata_T300250_Extreme_66.Timestamp+'&format=json&ApiKey=E03F2189-3202-4B60-B9CA-FBB74418D144';
 $.getJSON(WebAPI, function (data) {
                              if(data == null){
								var today = new Date();
								var Nodata = {};
								Nodata.Topic = capdata_T300250_Extreme_66.Topic;
        ...
        capdata_T300250_Extreme_66 = Nodata;
							}else{
                            if (data.Newflag) {         capdata_T300250_Extreme_66 = data;
								capdata_T300250_Extreme_66.Timestamp = data.Timestamp;
                            } else {
                                // alert('no change');
                            }}
                            iniCapData_Json_T300250_Extreme_66();
